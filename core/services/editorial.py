...
без прогнозов, диагнозов и self-help клише.

Для onboarding_insight приоритет — психологический портрет и паттерны поведения.
ЗАПРЕЩЕНО в body / product_pitch / opening.insight / outcomes: «Солнце в …», «Луна в …»,
«Асцендент в …», перечни знаков. Астрологию держи как скрытый каркас, на поверхности — опыт.
